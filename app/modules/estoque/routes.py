...
from app.modules.estoque import repository as repo
from app.modules.estoque.schemas import PecaCreate, PecaResponse, EntradaEstoque
...
@router.delete("/pecas/{peca_id}", status_code=204,
    ...
    description="Não permite remoção se a peça estiver vinculada a uma OS. **Requer ADMIN.**")
